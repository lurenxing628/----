...
EQUIPMENT_TOPICS: Dict[str, Dict[str, Any]] = {
    ...
    "excel_equipment": _topic(
        ...
        help_card=_card(
            ...
            "状态可填：可用 / 启用 / 正常 / active，停用 / 禁用 / 不可用 / inactive，维修 / 维护 / 维护中 / 维修中 / 保养 / maintain；状态不能为空，不是“不填默认可用”。",
            ...
            _section(
                ...
                "\n".join(
                    [
                        ...
                        "- `状态`：必填，可填 `可用/启用/正常/active`、`停用/禁用/不可用/inactive`、`维修/维护/维护中/维修中/保养/maintain`。",
                    ]
                ),
            ),
