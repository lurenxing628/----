...
REPORTS_TOPICS: Dict[str, Dict[str, Any]] = {
    ...
    "reports_overdue": _topic(
        title="超期清单",
        summary="超期清单用于定位哪些批次存在交期风险，是排产结果复盘最常看的报表之一。",
        full_manual_anchor="#9-1超期清单",
        help_card=_card(
            "超期清单先看哪些批次超了、超多久",
            "先看批次级超期情况，再去甘特图或资源排班中心看具体卡在哪里。",
        ...
        sections=[
            ...
            _section(
                ...
                "\n".join(
                    [
                        "- 先看哪些批次超期、超期多久，再去甘特图或资源排班中心看具体卡在哪里。",
    ...
    "reports_downtime": _topic(
        title="停机影响统计",
        summary="停机影响统计用于评估设备停机在所选时间段里占用了多少时间，以及它和排程任务重叠了多少。",
        full_manual_anchor="#9-3停机影响统计",
        help_card=_card(
            "停机影响先看设备层面的影响大小",
            "先看某台设备停了多久、停了几次，以及和排程任务重叠了多久。",
            "确认关键设备停机是否是超期的主要原因。",
            ...
            _section(
                ...
                "\n".join(
                    [
                        ...
                        "- 停机时间和已经排好的任务重叠了多久、重叠了几次。",
                        "- 如果要看具体是哪批任务受影响，请再回甘特图按同一时间段核对。",
                    ]
                ),
            ),
            _section(
