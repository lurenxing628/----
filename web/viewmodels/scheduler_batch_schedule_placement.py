...
def build_schedule_placement(
    *,
    ...
    return {
        ...
        "span_status": span_status or "ok",
        "span_bad_time_count": int(span_bad_time_count or 0),
        "span_notice": str(span_notice or "").strip(),
