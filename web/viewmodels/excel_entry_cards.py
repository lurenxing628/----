...
def process_parts_excel_cards() -> List[Dict[str, object]]:
    return _resolve_cards(
        (
            ExcelCardSpec(
                title="批量维护路线文字",
                desc="维护图号、名称和路线文字，系统会生成零件工序清单。",
                actions=(
                    ExcelActionSpec("批量维护路线", "process.excel_routes_page", "primary"),
            ...
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护工时", "process.excel_part_op_hours_page", "primary"),
    ...
    return _resolve_cards(
        (
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护工种", "process.excel_op_type_page", "primary"),
    ...
    return _resolve_cards(
        (
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护供应商", "process.excel_supplier_page", "primary"),
    ...
    return _resolve_cards(
        (
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护设备", "equipment.excel_machine_page", "primary"),
            ...
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护关系", "equipment.excel_link_page", "primary"),
    ...
    return _resolve_cards(
        (
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护人员", "personnel.excel_operator_page", "primary"),
            ...
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护关系", "personnel.excel_link_page", "primary"),
            ...
            ExcelCardSpec(
                ...
                actions=(
                    ExcelActionSpec("批量维护个人日历", "personnel.excel_operator_calendar_page", "primary"),
...
def scheduler_batch_excel_cards() -> List[Dict[str, object]]:
    return _resolve_cards(
        (
            ExcelCardSpec(
                title="批量维护批次",
                desc="适合按计划表整批新增或更新批次；确认写入后可自动生成批次工序。",
                actions=(
                    ExcelActionSpec("批量维护批次", "scheduler.excel_batches_page", "primary"),
