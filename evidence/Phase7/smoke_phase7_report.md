...
- 测试时间：2026-04-19 01:21:52
- Python：3.8.10 (tags/v3.8.10:3d8993a, May  3 2021, 11:48:03) [MSC v.1928 64 bit (AMD64)]
- 项目根目录（自动识别）：`D:\Github\APS Test`

## 0. 测试环境
- 临时目录：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase7_2krxafuq`
- 测试 DB：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase7_2krxafuq\aps_phase7_test.db`
...
- result_summary.algo 留痕：mode=improve objective=min_overdue metrics={'overdue_count': 1, 'total_tardiness_hours': 57.0, 'makespan_hours': 73.0, 'changeover_count': 0, 'weighted_tardiness_hours': 114.0, 'makespan_internal_hours': 25.0, 'machine_used_count': 2, 'operator_used_count': 1, 'machine_busy_hours_total': 25.0, 'operator_busy_hours_total': 25.0, 'machine_util_avg': 0.5, 'operator_util_avg': 1.0, 'machine_load_cv': 0.6, 'operator_load_cv': 0.0, 'internal_horizon_hours': 25.0, 'util_defined': True, 'invalid_due_count': 0, 'unscheduled_batch_count': 0, 'invalid_due_batch_ids_sample': [], 'unscheduled_batch_ids_sample': []}
- 冻结窗口预备：新增批次 B_FZ，用于验证部分冻结时仍可继续排产
- 冻结窗口校验：version=3 locked_cnt=5 unlocked_cnt=1 frozen_op_count=5
