...
## 文件超限
- [SIZE] core/services/personnel/operator_machine_service.py - 506 行（超过 500 行限制）
...
- [ENUM-INFO] core/services/common/enum_normalizers.py:144 - 枚举集合比较 ['yes']（可能是输入校验），建议使用 enums.py/normalize
...
- [ENUM-INFO] core/services/scheduler/config_service.py:402 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
- [ENUM-INFO] core/services/scheduler/config_service.py:408 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
- [ENUM-INFO] core/services/scheduler/config_service.py:425 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
- [ENUM-INFO] core/services/scheduler/config_service.py:436 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
- [ENUM-INFO] core/services/scheduler/config_service.py:483 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
...
- [COMPLEXITY] core/services/personnel/operator_machine_service.py:430 apply_import_links complexity=20 (rank C)
...
- [COMPLEXITY] core/infrastructure/backup.py:73 restore complexity=27 (rank D)
- [COMPLEXITY] core/infrastructure/database.py:41 _restore_db_file_from_backup complexity=16 (rank C)
- [COMPLEXITY] core/infrastructure/database.py:110 ensure_schema complexity=20 (rank C)
- [COMPLEXITY] core/infrastructure/database.py:295 _migrate_with_backup complexity=29 (rank D)
...
- [COMPLEXITY] core/infrastructure/migrations/v4.py:34 _sanitize_field complexity=39 (rank E)
