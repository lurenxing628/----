...
- [ENUM] core/services/process/part_service.py:70 - 裸字符串比较 '!= "internal"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:274 - 裸字符串比较 '== "internal"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:370 - 裸字符串比较 '!= "active"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:372 - 裸字符串比较 '!= "internal"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:396 - 裸字符串比较 '== "external"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:397 - 裸字符串比较 '== "active"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:449 - 裸字符串比较 '== "external"'，应使用 enums.py 枚举
- [ENUM] core/services/process/part_service.py:450 - 裸字符串比较 '== "active"'，应使用 enums.py 枚举
...
- [ENUM-INFO] web/routes/excel_demo.py:42 - 枚举集合比较 ['active', 'inactive']（可能是输入校验），建议使用 enums.py/normalize
...
- [ENUM-INFO] web/routes/personnel_excel_operators.py:32 - 枚举集合比较 ['active', 'inactive']（可能是输入校验），建议使用 enums.py/normalize
...
- [ENUM-INFO] core/services/process/part_service.py:83 - 枚举集合比较 ['yes', 'no']（可能是输入校验），建议使用 enums.py/normalize
...
## 圈复杂度超标
- [COMPLEXITY] web/routes/excel_demo.py:65 preview complexity=19 (rank C)
- [COMPLEXITY] web/routes/personnel_excel_operator_calendar.py:173 excel_operator_calendar_confirm complexity=19 (rank C)
- [COMPLEXITY] web/routes/process_excel_part_operation_hours.py:252 excel_part_op_hours_confirm complexity=31 (rank E)
...
- [COMPLEXITY] web/routes/system_logs.py:18 logs_page complexity=16 (rank C)
...
- [COMPLEXITY] core/services/process/part_service.py:378 delete_external_group complexity=16 (rank C)
- [COMPLEXITY] core/services/process/part_service.py:423 calc_deletable_external_group_ids complexity=16 (rank C)
...
- [COMPLEXITY] core/services/scheduler/schedule_persistence.py:10 persist_schedule complexity=41 (rank F)
