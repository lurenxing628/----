...
- 测试时间：2026-02-13 02:30:50
- Python：3.8.10 (tags/v3.8.10:3d8993a, May  3 2021, 11:48:03) [MSC v.1928 64 bit (AMD64)]
- 项目根目录：`D:\Github\APS Test`
- 临时目录：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase10_mqwbsqoj`
- 测试 DB：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase10_mqwbsqoj\aps_phase10_test.db`
...
- result_status=simulated failed_ops=8
...
## 6. SGS 派工：应可跑且无资源重叠
- SGS：version=3 failed_ops=0 scheduled_ops=8
...
- freeze_window：v4 -> v5 locked_count=3

## 9. OR-Tools 开关：可选项不应阻断排产
- ortools_enabled=yes：version=6 failed_ops=0（无论环境是否安装 ortools，都应可继续）
