...
- 测试时间：2026-01-30 00:32:49
- Python：3.8.10 (tags/v3.8.10:3d8993a, May  3 2021, 11:48:03) [MSC v.1928 64 bit (AMD64)]
- 项目根目录：`D:\Github\APS Test`

## 0. 测试环境（隔离目录）
- 临时目录：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase9_vu07b9bj`
- 测试 DB：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase9_vu07b9bj\aps_phase9_test.db`
- 备份目录：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase9_vu07b9bj\backups`
...
- 自动备份：通过（1 个，示例：aps_backup_20260130_003307_auto.db）
- 自动清理备份：通过（过期文件已删除）
