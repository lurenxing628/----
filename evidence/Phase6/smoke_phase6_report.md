...
- 测试时间：2026-01-28 00:43:44
- Python：3.8.10 (tags/v3.8.10:3d8993a, May  3 2021, 11:48:03) [MSC v.1928 64 bit (AMD64)]
- 项目根目录（自动识别）：`D:\Github\APS Test`

## 0. 测试环境
- 临时目录：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase6_p6uqrqz6`
- 测试 DB：`C:\Users\LURENX~1\AppData\Local\Temp\aps_smoke_phase6_p6uqrqz6\aps_phase6_test.db`
...
## 6. 排产配置：默认值/更新/校验
- 默认：{'sort_strategy': 'priority_first', 'priority_weight': 0.4, 'due_weight': 0.5, 'ready_weight': 0.1, 'prefer_primary_skill': 'no', 'dispatch_mode': 'batch_order', 'dispatch_rule': 'slack', 'auto_assign_enabled': 'no', 'ortools_enabled': 'no', 'ortools_time_limit_seconds': 5, 'algo_mode': 'greedy', 'time_budget_seconds': 20, 'objective': 'min_overdue', 'freeze_window_enabled': 'no', 'freeze_window_days': 0}
- 更新后：{'sort_strategy': 'weighted', 'priority_weight': 0.4, 'due_weight': 0.5, 'ready_weight': 0.1, 'prefer_primary_skill': 'no', 'dispatch_mode': 'batch_order', 'dispatch_rule': 'slack', 'auto_assign_enabled': 'no', 'ortools_enabled': 'no', 'ortools_time_limit_seconds': 5, 'algo_mode': 'greedy', 'time_budget_seconds': 20, 'objective': 'min_overdue', 'freeze_window_enabled': 'no', 'freeze_window_days': 0}
