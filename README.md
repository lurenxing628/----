...
本项目是面向 Win7 x64 离线单机与共享数据场景的本地 APS 智能排产系统。它的目标是在目标机不安装 Python、不依赖外网的前提下，完成基础资料维护、Excel 导入导出、批次排产、结果查看、报表导出、备份和恢复以及现场交付。
...
- **系统管理**：健康检查、备份和恢复、操作日志、排产历史、界面模式切换、插件开关。
