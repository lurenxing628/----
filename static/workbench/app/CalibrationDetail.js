(function () {
  ...
  function Report({
    ...
    return /*#__PURE__*/React.createElement("details", null, /*#__PURE__*/React.createElement("summary", null, "\u62A5\u5DE5 \xB7 ", report.actual_end ? window.WorkbenchFormat.dateTime(report.actual_end) : '结束时间未知', " \xB7 \u6570\u91CF ", text(report.completed_quantity), " \xB7 ", hours(report.effective_processing_hours, '工时未知')), /*#__PURE__*/React.createElement(Refs, {
      ...
      supplement: '补录',
      correct: '更正'
    }[revision.action] || revision.action, " \xB7 ", window.WorkbenchFormat.dateTime(revision.recorded_at)), /*#__PURE__*/React.createElement(Refs, {
    ...
    }, "\u9010\u6B21\u62A5\u5DE5\u4FEE\u8BA2\u524D\u540E\u7684\u5B57\u6BB5\u503C"), /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", {
      scope: "col"
      ...
      scope: "row"
    }, label), /*#__PURE__*/React.createElement("td", null, revision.before === null ? '首次登记，无前值' : text(revision.before && revision.before[key])), /*#__PURE__*/React.createElement("td", null, text(revision.after && revision.after[key]))))))), /*#__PURE__*/React.createElement(window.WorkbenchReference, {
      entries: {
  ...
  function Sample({
    ...
    }, /*#__PURE__*/React.createElement("summary", null, "\u65E7\u73B0\u573A\u8BB0\u5F55 ", index + 1), /*#__PURE__*/React.createElement(window.ReportEvidence.StructuredFacts, {
      value: fact
  ...
  function Detail({
    ...
    return /*#__PURE__*/React.createElement(window.WorkbenchDetailPanel, {
      ...
      key: reason.code + ':' + index
    }, reason.message, "\uFF08", reason.count, " \u4E2A\u5B9E\u4F8B\uFF09")))), /*#__PURE__*/React.createElement("h3", null, "\u6837\u672C\u4E0E\u6765\u6E90\u6838\u5BF9"), sampleRef && !data.samples.some(sample => sample.sample_ref === sampleRef) && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
      className: "ca-note"
    }, "\u539F\u9009\u5B9E\u4F8B\u5DF2\u4E0D\u5728\u8FD4\u56DE\u7ED3\u679C\u4E2D\uFF0C\u672A\u9009\u62E9\u5176\u4ED6\u6765\u6E90\u3002"), /*#__PURE__*/React.createElement(window.WorkbenchReference, {
      value: sampleRef,
      label: "\u539F\u9009\u5B9E\u4F8B\u7F16\u53F7"
