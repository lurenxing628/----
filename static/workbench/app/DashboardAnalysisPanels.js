(function () {
  ...
  function Delivery({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.DashboardTimeline, {
      ...
      onClick: onCompare
    }, "\u5BF9\u6BD4\u5019\u9009\u65B9\u6848")), /*#__PURE__*/React.createElement("div", {
      className: "dy-scroll"
  ...
  function Downtime({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(window.DashboardTimeline, {
      ...
      scope: "col"
    }, "\u91CD\u53E0\u65F6\u95F4"))), /*#__PURE__*/React.createElement("tbody", null, data.overlaps.map(row => /*#__PURE__*/React.createElement("tr", {
      key: row.task_ref,
  ...
  function Actual({
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      }, "\u73B0\u573A\u8BB0\u5F55"), /*#__PURE__*/React.createElement(Button, {
        reasonDisplay: "inline",
        icon: "chart-gantt",
        onClick: () => navigate({
          view: 'fieldgantt',
