(function () {
  ...
  function WorkbenchGuardHost() {
    ...
    return ReactDOM.createPortal(/*#__PURE__*/React.createElement("div", {
      ...
      title: prompt.locked ? '原请求尚未核实' : '离开前确认',
      icon: "circle-alert",
      guardBypass: true,
      onClose: close,
      ...
      role: "status"
    }, "\u64CD\u4F5C\u7ED3\u679C\u4ECD\u5F85\u6838\u5B9E\uFF0C\u8BF7\u4FDD\u7559\u5F53\u524D\u9875\u9762\u5E76\u67E5\u8BE2\u539F\u8BF7\u6C42\uFF0C\u4E0D\u80FD\u653E\u5F03\u6216\u91CD\u590D\u63D0\u4EA4\u3002"), /*#__PURE__*/React.createElement("ul", null, prompt.messages.map(message => /*#__PURE__*/React.createElement("li", {
      key: message
