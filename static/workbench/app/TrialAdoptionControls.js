(function () {
  ...
  function Scope({
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("dl", {
      ...
      className: "ta-note"
    }, "\u5C06\u5B8C\u6574\u8BD5\u8C03\u65B9\u6848\u91C7\u7528\u4E3A\u65B0\u4E00\u7248\u6B63\u5F0F\u8BA1\u5212\uFF0C\u4FDD\u7559\u5386\u53F2\u7248\u672C\u3002\u6062\u590D\u65E7\u5B89\u6392\u9700\u91CD\u65B0\u6392\u4EA7\u5E76\u91C7\u7528\u3002"));
  }
  function Fields({
    session: s
  }) {
    ...
    }), !frozen && memoryHint && /*#__PURE__*/React.createElement("small", null, memoryHint)), (!s.saved || s.saved.phase === 'rejected') && /*#__PURE__*/React.createElement("label", {
    ...
    }), /*#__PURE__*/React.createElement("span", null, "\u786E\u8BA4\u5C06\u5B8C\u6574\u8BD5\u8C03\u65B9\u6848\u6B63\u5F0F\u91C7\u7528\u3002")), frozen && /*#__PURE__*/React.createElement("small", null, "\u5DF2\u63D0\u4EA4\u7684\u5185\u5BB9\u6682\u4E0D\u53EF\u4FEE\u6539\u3002"));
  }
  function Records({
    value,
    saved,
  ...
  function Dialog({
    ...
    return /*#__PURE__*/React.createElement(Modal, {
      ...
      className: "ta-notice",
      role: "status"
    }, "\u53E6\u4E00\u4E2A\u8BD5\u8C03\u65B9\u6848\u7684\u91C7\u7528\u7ED3\u679C\u5F85\u786E\u8BA4\uFF0C\u8BF7\u5148\u67E5\u8BE2\u7ED3\u679C\u3002"), s.notice && /*#__PURE__*/React.createElement("div", {
      className: "ta-notice",
      role: "status"
      ...
      className: "ta-result",
      role: "status"
    }, "\u5DF2\u786E\u8BA4\uFF1A\u8FD9\u6B21\u751F\u6210\u6B63\u5F0F\u8BA1\u5212\u7B2C ", s.result.data.official_plan.version, " \u7248\uFF0C\u5171 ", s.result.data.row_count, " \u9053\u5DE5\u5E8F\u3002", /*#__PURE__*/React.createElement("p", null, "\u5F53\u524D\u6B63\u5F0F\u8BA1\u5212\u53EF\u5728\u8BA1\u5212\u5217\u8868\u67E5\u770B\u3002"), s.result.replayed && /*#__PURE__*/React.createElement("p", null, "\u5DF2\u67E5\u8BE2\u5230\u4E0A\u6B21\u91C7\u7528\u7ED3\u679C\u3002")), value.baseline && /*#__PURE__*/React.createElement(Scope, {
      value: value,
      name: name,
      ...
      className: "ta-note"
    }, "\u4E0A\u6B21\u91C7\u7528\u672A\u901A\u8FC7\uFF0C\u8BF7\u91CD\u65B0\u68C0\u67E5\u5E76\u786E\u8BA4\u3002"), !s.result ? /*#__PURE__*/React.createElement(Fields, {
      session: s
