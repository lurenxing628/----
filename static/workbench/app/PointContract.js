(function () {
  ...
  const isPoint = row => !!row && row.event_kind === 'point' && row.duration_seconds === 0 && row.occupies_resources === false && typeof row.start === 'string' && row.start === row.end;
