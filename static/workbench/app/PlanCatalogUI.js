  ...
  function Catalog({
    ...
    React.useLayoutEffect(() => {
      if (collapsed && restoreFocus.current && section.current) {
        ...
        section.current.querySelector('[aria-label="展开计划列表"]').focus();
      }
    }, [collapsed]);
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      value: selectedRef
    }, "\u5DF2\u9009\u8BA1\u5212\uFF08\u5728\u5176\u4ED6\u9875\uFF09"), data && data.plans.filter(plan => plan.plan_ref).map(plan => /*#__PURE__*/React.createElement("option", {
      key: plan.plan_ref,
      value: plan.plan_ref,
      ...
      value: collection,
      options: [["history", "历史版本"], ["scenario", "试调方案"]],
      label: "\u8BA1\u5212\u5217\u8868\u8303\u56F4",
      onChange: refresh,
      disabled: disabled
    }), /*#__PURE__*/React.createElement("div", {
      ...
      "aria-label": collapsed ? '展开计划列表' : '收起计划列表',
    ...
    }, /*#__PURE__*/React.createElement("span", null, paused ? '计划列表读取已取消。' : '计划列表没有读成功，已选的计划没有变。'), /*#__PURE__*/React.createElement(Button, {
      icon: "refresh-cw",
      onClick: () => refresh()
    }, "\u5237\u65B0\u5217\u8868")), result && /*#__PURE__*/React.createElement(Issues, {
      issues: result.warnings
    }), !collapsed && /*#__PURE__*/React.createElement("div", {
      className: "plan-catalog-scroll wb-table-frame",
      "data-wb-scroll-key": "plan-catalog",
      ...
      title: read.loading ? '正在读取计划列表…' : paused ? '读取已取消' : read.error ? '计划列表读取失败' : '本页没有计划记录。'
