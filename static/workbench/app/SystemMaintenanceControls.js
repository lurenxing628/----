(function () {
  ...
  function Styles() {
    return /*#__PURE__*/React.createElement("style", null, `.sm-maintenance-workspace .sm-field,.sm-maintenance-workspace .sm-meta,.sm-maintenance-workspace .sm-note{font-size:13px}
      .sm-maintenance-workspace .sm-record-table tbody tr:hover{background:var(--ui-surface-muted)}
      .sm-maintenance-workspace .sm-record-table tbody tr:focus-visible{outline:2px solid var(--ui-info-text);outline-offset:-2px}
      .sm-maintenance-workspace .sm-record-table th{text-align:left}
      .sm-maintenance-workspace .sm-record-table th:last-child{text-align:center}
      .sm-maintenance-workspace .sm-filters{grid-template-columns:repeat(4,minmax(0,1fr))}
      @media(max-width:800px){.sm-maintenance-workspace .sm-filters{grid-template-columns:repeat(2,minmax(0,1fr))}}`);
  }
  function ErrorBox({
    error
  }) {
    return error ? /*#__PURE__*/React.createElement("p", {
      className: "sm-notice sm-error",
      role: "alert"
    }, error.message || String(error), error.code && /*#__PURE__*/React.createElement("span", null, " \xB7 ", error.code)) : null;
  }
  ...
  function Confirm({
    ...
    }, row && /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, row.filename), /*#__PURE__*/React.createElement("br", null), "\u6587\u4EF6\u4FEE\u6539\u65F6\u95F4 ", row.time.replace('T', ' '), " \xB7 ", row.size_bytes, " \u5B57\u8282", /*#__PURE__*/React.createElement("br", null), "\u6587\u4EF6\u5B58\u5728\uFF0C\u5C1A\u65E0\u672C\u6B21\u5B8C\u6574\u6027\u6821\u9A8C\u8BC1\u636E\u3002"), /*#__PURE__*/React.createElement("p", null, action === 'create' ? '创建本机数据库备份。结果以外置维护记录为准。' : action === 'delete' ? '仅删除此备份文件，删除后不能撤销。' : '将用所选备份替换当前数据库。恢复前保护副本、校验和失败回滚均由后端执行。'), action === 'restore' && /*#__PURE__*/React.createElement("p", {
      className: "sm-notice"
  ...
  function Outcome({
    ...
    }, "\u786E\u8BA4\u7ED3\u679C"))), intent && /*#__PURE__*/React.createElement("p", {
      className: "sm-meta"
    }, "\u539F\u8BF7\u6C42\uFF1A", intent.request_key), /*#__PURE__*/React.createElement(ErrorBox, {
    ...
    }, labels[op.state]), " \xB7 ", op.message, " \xB7 ", op.code), /*#__PURE__*/React.createElement("p", null, "\u5916\u7F6E\u7EF4\u62A4\u8BB0\u5F55\uFF1A", op.job_ref, " \xB7 ", op.updated_at.replace('T', ' '), /*#__PURE__*/React.createElement("br", null), "\u4E1A\u52A1\u5BA1\u8BA1\uFF1A", op.audit_persisted ? '已留存' : '未确认留存', op.replayed ? ' · 查询原结果' : ''), op.filename && /*#__PURE__*/React.createElement("p", null, "\u76EE\u6807\u6587\u4EF6\uFF1A", op.filename), op.protection_filename && /*#__PURE__*/React.createElement("p", null, "\u4FDD\u62A4\u526F\u672C\uFF1A", op.protection_filename), /*#__PURE__*/React.createElement("details", {
      className: "sm-rules"
    }, /*#__PURE__*/React.createElement("summary", null, "\u7EF4\u62A4\u9636\u6BB5"), op.history.map((step, index) => /*#__PURE__*/React.createElement("p", {
      key: index
    }, step.time.replace('T', ' '), " \xB7 ", labels[step.state])))) : result && result.kind === 'config' ? /*#__PURE__*/React.createElement("div", {
      role: "status"
    }, /*#__PURE__*/React.createElement("p", null, result.command.result === 'committed' ? '八项维护配置已保存，事务和审计已留存。' : '配置没有变化，已留存无变更回执；未新增业务审计。'), /*#__PURE__*/React.createElement("p", null, "\u914D\u7F6E\u56DE\u6267\uFF1A", result.command.receipt_ref, result.command.replayed ? ' · 查询原结果' : '')) : result && result.kind === 'rejected' ? /*#__PURE__*/React.createElement("p", {
      role: "status"
