(function () {
  ...
  function Metrics({
    ...
    }, /*#__PURE__*/React.createElement("td", null, row.label || '名称未填写', " \xB7 \u65E5\u5CF0\u503C"), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement(Peak, {
      value: row.before
  ...
  function Batches({
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      scope: "col"
    }, "\u6392\u4EA7\u65F6\u8BA1\u5212\u5B8C\u5DE5"), /*#__PURE__*/React.createElement("th", {
      scope: "col"
    }, "\u5019\u9009\u8BA1\u5212\u5B8C\u5DE5"), /*#__PURE__*/React.createElement("th", {
      scope: "col"
    }, "\u6392\u4EA7\u65F6 / \u5019\u9009"), /*#__PURE__*/React.createElement("th", {
      scope: "col"
    }, "\u8D85\u671F\u53D8\u5316\uFF08\u5C0F\u65F6\uFF09"))), /*#__PURE__*/React.createElement("tbody", null, data.batches.map(row => /*#__PURE__*/React.createElement("tr", {
      key: row.batch_ref,
    ...
    }, row.batch_id), /*#__PURE__*/React.createElement("small", null, row.part_label || '名称未填写')), /*#__PURE__*/React.createElement("td", null, row.after.due_date || '未知'), /*#__PURE__*/React.createElement("td", null, row.before.planned_finish ? window.WorkbenchFormat.dateTime(row.before.planned_finish) : '工序未排完'), /*#__PURE__*/React.createElement("td", null, row.after.planned_finish ? window.WorkbenchFormat.dateTime(row.after.planned_finish) : '工序未排完'), /*#__PURE__*/React.createElement("td", null, risk(row.before), " / ", risk(row.after)), /*#__PURE__*/React.createElement("td", null, signed(row.delay_delta_hours))))))));
  }
  function Summary({
    data,
    onClose
    ...
    }, /*#__PURE__*/React.createElement("h3", null, data.candidate.label || '候选方案名称未填写'), /*#__PURE__*/React.createElement("dl", {
      className: "dy-facts"
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("dt", null, "\u6392\u4EA7\u65F6\u7684\u6B63\u5F0F\u8BA1\u5212"), /*#__PURE__*/React.createElement("dd", null, data.baseline.baseline_ref ? '已读到排产时的正式计划' : '排产时没有正式计划')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("dt", null, window.WorkbenchTerms.overdue_count), /*#__PURE__*/React.createElement("dd", null, number(data.summary.after.overdue_count))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("dt", null, window.WorkbenchTerms.total_tardiness_hours), /*#__PURE__*/React.createElement("dd", null, number(data.summary.after.total_tardiness_hours), " \u5C0F\u65F6")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("dt", null, "\u540C\u8303\u56F4\u6362\u578B\u6B21\u6570"), /*#__PURE__*/React.createElement("dd", null, number(data.summary.after.changeovers.value))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("dt", null, "\u6362\u8BBE\u5907\u5DE5\u5E8F"), /*#__PURE__*/React.createElement("dd", null, number(data.machine_changes.count), " \xB7 \u5DF2\u786E\u8BA4 ", data.machine_changes.known_count, " \xB7 \u672A\u77E5 ", data.machine_changes.unknown_count))), /*#__PURE__*/React.createElement(window.WorkbenchReference, {
      entries: {
        '候选编号': data.candidate.candidate_ref,
        '排产时正式计划编号': data.baseline.baseline_ref
      }
