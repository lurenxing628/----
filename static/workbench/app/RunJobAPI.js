  ...
  function pending(storage) {
    ...
    function save(v) {
      try {
        ...
        throw new Error('存不下这次排产的操作记录，没有开始排产。请重新打开页面。');
      }
      check(same(read(), v), '上次操作记录没能保存，这次不能开始排产。');
      return v;
    }
    function read() {
      let raw;
      ...
      try {
        ...
        throw new Error('本机存的排产操作记录已损坏，已拦下新排产。请不要再操作，联系维护人员。');
      }
    ...
    return {
      ...
      reject(intent) {
        ...
        try {
          ...
          throw new Error('本机无法更新上次操作记录。请不要再操作，联系维护人员。');
        }
