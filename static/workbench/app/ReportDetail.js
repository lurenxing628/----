(function () {
  ...
  const fields = [['actual_start', '实际开工'], ['actual_end', '本次实际结束'], ['completed_quantity', '本次完成数量'], ['effective_processing_hours', '有效加工工时'], ['remark', '备注']];
  function Evidence({
    record
  }) {
    const {
    ...
    return /*#__PURE__*/React.createElement("details", {
      ...
      correct: '更正',
      supplement: '补录'
    }[revision.action] || revision.action, " \xB7 ", time(revision.recorded_at)), /*#__PURE__*/React.createElement("p", null, "\u539F\u56E0\uFF1A", revision.reason || '无', "\uFF1B\u767B\u8BB0\u4EBA\u5458\uFF1A", text(revision.local_operator), "\uFF1B\u58F0\u660E\u4EBA\u5458\uFF1A", text(revision.declared_operator)), /*#__PURE__*/React.createElement(window.ReportEvidence.TableFrame, {
      caption: "\u62A5\u5DE5\u4FEE\u8BA2\u524D\u540E\u503C"
      ...
      entries: {
        '修订编号': revision.revision_ref,
        '回执编号': revision.receipt_ref,
