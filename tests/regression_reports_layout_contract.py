...
def test_report_pages_use_stable_filter_grid_and_preserve_contracts() -> None:
    pages = (
        ("templates/reports/overdue.html", ("version",), ("overdueTable",)),
        ("templates/reports/utilization.html", ("version", "start_date", "end_date"), ("utilizationMachineTable", "utilizationOperatorTable")),
        ("templates/reports/downtime.html", ("version", "start_date", "end_date"), ("downtimeTable",)),
    )
