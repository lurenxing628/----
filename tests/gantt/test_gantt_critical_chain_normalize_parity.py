...
def _expected(
    *,
    ...
    edge_count: int = 0,
    dropped_count: int = 0,
    critical_chain_partial: bool = False,
    available: bool = True,
    reason: str = "",
    reason_code: str = "",
) -> Dict[str, Any]:
    return {
        ...
        "critical_chain_partial": critical_chain_partial,
        "available": available,
        "reason": reason,
...
_CASES: List[Tuple[str, Any, Dict[str, Any]]] = [
    ...
    (
        "dropped rows mark partial",
        {"dropped_count": "2"},
        _expected(dropped_count=2, critical_chain_partial=True),
    ),
    (
        "explicit partial survives without dropped rows",
        {"critical_chain_partial": True},
        _expected(critical_chain_partial=True),
    ),
    (
