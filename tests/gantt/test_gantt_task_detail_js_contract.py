...
for (const label of ['任务详情','B1','10','车削','设备','一号设备','人员','张三','计划开始','2026-05-01 08:00:00','计划结束','2026-05-01 09:00:00','1.00 小时']) assert(text.includes(label),label);
