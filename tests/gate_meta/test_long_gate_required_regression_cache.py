...
@pytest.mark.parametrize(
    ...
    [
        ...
        ".codestable/issues/2026-05-25-quality-gate-timeout/quality-gate-timeout-checklist.yaml",
        ".codestable/requirements/schedule-delay-diagnosis.md",
        ...
        ".codestable/roadmap/aps-three-gap-directions/aps-three-gap-directions-items.yml",
        ".limcode/skills/aps-full-selftest/scripts/run_full_selftest.py",
        ".limcode/plans/core目录系统性修复/05_后续结构债治理与文档同步.plan.md",
        "evidence/README.md",
        "evidence/current/README.md",
