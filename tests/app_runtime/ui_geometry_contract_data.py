...
GEOMETRY_CASES = (
    ...
    _case("analysis", "analysis", ["[data-plan-workspace]", '.plan-projections table'],
          ["所选计划", BATCH], action="plan", plan_scope=True, summaries=[".wb-metrics"]),
    ...
    _case("field", "field", ['table[aria-label="现场任务列表"]', 'nav.wb-pager[aria-label="现场分页"]'],
    ...
    _case("reports-overdue", "reports", ['[aria-label="其他报表列表"] table'],
          ["报表中心", "超期批次"], action="report-catalog", catalog="overdue", report_scope=True),
    _case("reports-utilization", "reports", ['[aria-label="其他报表列表"] table'],
          ["统计范围：2026-05-06 至 2026-05-06"], action="report-catalog",
    ...
    _case("reports-downtime", "reports", ['[aria-label="其他报表列表"] table'],
          ["统计范围：2026-05-06 至 2026-05-06", "几何测试设备"], action="report-catalog",
