...
SCHEDULER_REQUIRED_REGRESSION_GROUPS = (
    {
        ...
        "input_file_scopes": (
            ...
            "tests/workbench/test_pending_build_sources.py",
            "tests/workbench/test_process_readiness.py",
            "开发文档/技术债务治理台账.md",
            "evidence/README.md",
    ...
    },
    {
        ...
        "input_file_scopes": (
            ...
            "tests/_scripts_e2e/benchmark_sgs_large_resource_pool.py",
            "tests/_support/optimizer_benchmark_*.py",
    ...
    },
    {
        ...
        "input_file_scopes": (
            ...
            "tests/_support/gantt_current_js.py",
            "tests/_support/gantt_current_runtime.cjs",
            "tests/_support/gantt_current_failure.py",
            ...
            "web/routes/workbench/navigation_*.py",
            "web/routes/workbench/legacy_*.py",
            "templates/workbench/*.html",
            "frontend/workbench/app/Plan*.jsx",
            "static/workbench/app/Plan*.js",
            "static/workbench/app/Point*.js",
            "static/workbench/app/ResourceControls.js",
            "static/workbench/app/resource-*.js",
            "static/workbench/vendor/react-18.3.1.production.min.js",
            "static/workbench/prototype/ui_kits/workbench/gantt-theme.css",
