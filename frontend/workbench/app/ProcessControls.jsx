(function () {
  ...
  function ProcessFileButtons({ capabilities, disabled, hoursOnly = false, onAction }) {
    return <>{(hoursOnly ? [['hours', '工时定额']] : [['route', '工艺路线'], ['hours', '工时定额']]).map(([kind, label]) => <React.Fragment key={kind}>
