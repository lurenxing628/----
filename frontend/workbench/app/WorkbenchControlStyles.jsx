(function () {
  ...
  const ICONS = Object.freeze({ '--wb-control-select-icon': 'chevron-down', '--wb-control-date-icon': 'calendar-days', '--wb-control-time-icon': 'clock-3', '--wb-control-disclosure-icon': 'chevron-right' });
