...
- **引用格式**：`详见 [排产优化_核心算法](排产优化_核心算法.md#6-核心算法设计)`，使用相对路径 + 锚点。
...
### 与现有开发文档体系的联动（v1.3.0 判断）

| 联动文档 | 本次是否需要更新 | 理由 |
|----------|:---:|------|
| [系统速查表.md](../系统速查表.md) | 否 | 本次未新增 DB 字段/表/ScheduleConfig 键，均为方案设计文档整理 |
| [面板与接口清单.md](../面板与接口清单.md) | 否 | 本次未新增页面/路由/用户可见提示 |
| [开发文档.md](../开发文档.md) | 否 | 本次未变更 Repository/Model 接口 |
| `开发文档/ADR/` | 是 | 已新增 ADR 0009~0011 占位（Web 异步/ext_group_id/efficiency） |

后续联动规则：专题文档若落实新字段/路由/配置键，必须按上表分类同步。
