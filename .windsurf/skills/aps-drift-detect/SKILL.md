...
```bash
# Step 1: 综合检测脚本
python .windsurf/skills/aps-drift-detect/scripts/drift_detect.py

# 可选：调整各子步骤 timeout（秒）
# python .windsurf/skills/aps-drift-detect/scripts/drift_detect.py --timeout 180 --timeout-ruff 300
