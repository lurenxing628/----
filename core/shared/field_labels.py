...
CONFIG_FIELD_LABELS = {
    ...
    "graph_analysis_mode": "工序图分析模式",
    "graph_block_on_cycle": "图分析发现环时阻止排产",
    "graph_critical_weight": "工序图关键路径评分权重",
    "graph_debug_export": "输出工序图调试文件",
    "graph_impact_weight": "工序图后续影响范围评分权重",
