...
def _execution_review_values(row: Dict[str, Any]) -> List[Any]:
    return [
        ...
        row.get("exception_affected_machine_export_label") or row.get("exception_affected_machine_label"),
        row.get("exception_affected_operator_export_label") or row.get("exception_affected_operator_label"),
        row.get("exception_handling_status_label"),
        row.get("exception_suggest_reschedule_label"),
        row.get("planned_resource_export_label") or row.get("planned_resource_label"),
        row.get("actual_resource_export_label") or row.get("actual_resource_label"),
