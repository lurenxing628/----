...
class ConfigService:
    ...
    DEFAULT_GRAPH_ANALYSIS_MODE = DEFAULT_GRAPH_ANALYSIS_MODE
    DEFAULT_GRAPH_BLOCK_ON_CYCLE = DEFAULT_GRAPH_BLOCK_ON_CYCLE
    DEFAULT_GRAPH_CRITICAL_WEIGHT = DEFAULT_GRAPH_CRITICAL_WEIGHT
    DEFAULT_GRAPH_IMPACT_WEIGHT = DEFAULT_GRAPH_IMPACT_WEIGHT
    DEFAULT_GRAPH_DEBUG_EXPORT = DEFAULT_GRAPH_DEBUG_EXPORT
    ...
    VALID_GRAPH_ANALYSIS_MODES = VALID_GRAPH_ANALYSIS_MODES
