...
def normalize_dispatch_row(
    *,
    ...
    normalized = {
        ...
        "latest_exception_affected_machine_id": _text(row.get("latest_exception_affected_machine_id")),
        "latest_exception_affected_machine_name": _text(row.get("latest_exception_affected_machine_name")),
        "latest_exception_affected_machine_display_label": _text(row.get("latest_exception_affected_machine_display_label")),
        "latest_exception_affected_machine_identity_label": _text(row.get("latest_exception_affected_machine_identity_label")),
        "latest_exception_affected_machine_label": _text(row.get("latest_exception_affected_machine_label")),
        "latest_exception_affected_operator_id": _text(row.get("latest_exception_affected_operator_id")),
        "latest_exception_affected_operator_name": _text(row.get("latest_exception_affected_operator_name")),
        "latest_exception_affected_operator_display_label": _text(row.get("latest_exception_affected_operator_display_label")),
        "latest_exception_affected_operator_identity_label": _text(row.get("latest_exception_affected_operator_identity_label")),
        ...
        "actual_machine_id": _text(row.get("actual_machine_id")),
        "actual_machine_name": _text(row.get("actual_machine_name")),
        "actual_machine_display_label": _text(row.get("actual_machine_display_label")),
        "actual_machine_identity_label": _text(row.get("actual_machine_identity_label")),
        "actual_machine_label": _text(row.get("actual_machine_label")),
        "actual_operator_id": _text(row.get("actual_operator_id")),
        "actual_operator_name": _text(row.get("actual_operator_name")),
        "actual_operator_display_label": _text(row.get("actual_operator_display_label")),
        "actual_operator_identity_label": _text(row.get("actual_operator_identity_label")),
        "actual_operator_label": _text(row.get("actual_operator_label")),
    }
