...
const trees = ['templates', 'static', 'web', 'core', 'data', 'assets', 'installer', 'plugins',
  'tools', 'scripts', 'tests', '前端设计'];
const files = ['app.py', 'config.py', 'schema.sql', 'requirements.txt', 'requirements-dev.txt',
  'requirements-optimizer-lite-win7.txt', 'pyproject.toml', 'build_win7_onedir.bat',
  'build_win7_installer.bat', 'validate_dist_exe.py', '.gitignore', 'AGENTS.md'];
