...
# Finding 05：甘特详情区第一版做，资源负荷摘要第二阶段做

## 结论

甘特页的只读、禁拖、禁保存基础已经较稳。第一版可以先补右侧稳定详情区和计划/实际小结；资源负荷 Top 摘要放到第二阶段增强。两者都不需要改排程算法，但容量来源和停机扣除不能乱承诺。
...
- 第一版：补甘特稳定详情区、计划/实际小结、超期说明入口和下一步链接。
- 第二阶段：复用资源负荷报表，给甘特页补 Top 5 设备/人员和容量来源说明。

## 风险

第一版不要顺手做左侧任务简表、保存视图、模拟沙盒或甘特资源负荷 Top 摘要。设计稿把这些放到后续阶段；现在硬塞会挤压甘特主区。
