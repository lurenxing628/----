...
- 当前短期产品形态是计划员单人操作，现场人员只向计划员汇报，不做多人现场终端。
- 第一版动作白名单按开工总方案收敛为开工、完工、查看记录；如果保留“填写实际情况”大表单，也只能作为计划员代录现场事实的入口，不能引出现场员工登录。
- 暂停、继续、报异常、撤销、审批、扫码、消息推送全部后移，不进入第一版入口。
- 反馈人短期已确认不必填，空了不阻断保存和报表。
