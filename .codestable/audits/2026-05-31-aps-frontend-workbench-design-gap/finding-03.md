...
首页现在是统计卡和常用入口，不是计划员值班台。只改模板可以换骨架，但“今日待处理”“资源高负荷”“现场反馈缺口”“方案待确认”需要新增首页聚合规则。
...
- 计划和现场实际服务能看到现场状态，但首页没有统一“反馈缺口”统计：`core/services/report/execution_review.py:94`、`:241`。
