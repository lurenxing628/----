...
summary: "批次、日历、外协与报工的字段校验、首错焦点和错误去重实现已收尾；验收结论为completed-with-validation-limit。"
...
覆盖Field原id/describedby保留、必填名称、input.路径归一和重复错误去重、未映射错误保留、折叠details先展开再聚焦、默认inline禁用原因关联、显式title模式、110px操作列中的长中文原因完整换行。Modal验证只检查当前owner、取消保留与确认仅关闭一次、只读弹窗不打断别处草稿。
...
- `frontend/workbench/app/ResourceControls.jsx`：`1109b610a054690c85c3991122cacc6e8f8a32e8a1266d1d8a0a8d2747d1b36d`
- `frontend/workbench/app/ResourceForms.jsx`：`7637a53316c7cc59c9392ee344c63e72b6fdc1306bc91c8b1e5764d154c45e9a`
