...
summary: "列表空态与加载态、页码及游标分页的共同合同实现已收尾；验收结论为completed-with-validation-limit。"
...
覆盖系统API的10/25/50原分页档位、准确总数/页码、数字跳页边界与Enter操作、多分页器jumpActionLabel区分、cursor不伪造total/pages、loading读屏状态及filtered恢复动作。
...
- `frontend/workbench/app/WorkbenchListControls.jsx`：`6fcaec9057ec3c17f2a3cc20b76a9d24510bfaa4760417b90c03eecea9fb8280`
