...
slug: wbui-viewport-budget
status: "completed-with-validation-limit"
created: 2026-09-12
feature: 2026-09-12-wbui-viewport-budget
roadmap: workbench-ui-refinement
roadmap_item: wbui-viewport-budget
summary: "侧栏与页面视口预算、卡片和操作区可用性及窄屏布局实现已收尾；验收结论为completed-with-validation-limit。"
tags:
- workbench
- ui
